...
from pysqldbm.resources.compare import Compare
...
class Alters(BaseModel):
    ...
    def get_compare(self, revision_id: str, environment_id: str, with_revision_id: str,
                    with_environment_id: str) -> Alter:
        return self._client.get_one(f"projects/{self._project_id}/alter/compare", Alter, query={
